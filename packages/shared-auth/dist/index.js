...
exports.CrossPortAuth = exports.crossPortAuth = void 0;
class CrossPortAuth {
    constructor(options) {
        this.storageKey = 'poultry360-auth';
...
exports.CrossPortAuth = CrossPortAuth;
// Create default instance
exports.crossPortAuth = new CrossPortAuth({
    mainAppPort: 3000,
    doctorAppPort: 3002,
