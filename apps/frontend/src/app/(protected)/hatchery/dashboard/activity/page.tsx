...
function HatcheryActivityContent() {
...
export default function HatcheryActivityPage() {
  return <AccountFeatureGuard featureKey={ACCOUNT_FEATURE_KEYS.HATCHERY_STAFF_OPERATIONS} fallbackHref="/hatchery/dashboard/home"><HatcheryActivityContent /></AccountFeatureGuard>;
}
