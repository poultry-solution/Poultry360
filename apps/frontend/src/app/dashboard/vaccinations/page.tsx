...
export default function VaccinationsPage() {
  ...
  const createMultiDoseMutation = useCreateMultiDoseVaccination();
  ...
  const handleCreateVaccination = async (e: React.FormEvent) => {
    ...
    if (!createForm.vaccineName.trim() || !createForm.scheduledDate) {
    ...
    try {
      await createVaccinationMutation.mutateAsync({
        ...createForm,
        batchId: createForm.batchId === "none" ? undefined : createForm.batchId,
        farmId: createForm.farmId === "none" ? undefined : createForm.farmId,
  ...
  const handleCreateMultiDose = async (e: React.FormEvent) => {
    e.preventDefault();
    
    if (!multiDoseForm.vaccineName.trim() || !multiDoseForm.firstDoseDate) {
      toast.error("Please fill in all required fields");
      return;
    }

    try {
      await createMultiDoseMutation.mutateAsync({
        ...multiDoseForm,
        batchId: multiDoseForm.batchId === "none" ? undefined : multiDoseForm.batchId,
        farmId: multiDoseForm.farmId === "none" ? undefined : multiDoseForm.farmId,
        firstDoseDate: new Date(multiDoseForm.firstDoseDate).toISOString(),
      });

      toast.success(`Created ${multiDoseForm.totalDoses} vaccination doses`);
      setIsMultiDoseModalOpen(false);
      setMultiDoseForm({
        vaccineName: "",
        firstDoseDate: "",
        totalDoses: 2,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Create Single Vaccination Modal */}
      <Modal
      ...
      >
        <form onSubmit={handleCreateVaccination}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateCreateForm("vaccineName", e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateCreateForm("scheduledDate", e.target.value)}
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateCreateForm("doseNumber", parseInt(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateCreateForm("totalDoses", parseInt(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateCreateForm("daysBetweenDoses", parseInt(e.target.value))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={createForm.farmId} onValueChange={(value) => updateCreateForm("farmId", value)}>
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select value={createForm.batchId} onValueChange={(value) => updateCreateForm("batchId", value)}>
                    <SelectTrigger>
                      <SelectValue placeholder="Select batch" />
                    </SelectTrigger>
                    <SelectContent position="popper">
                      <SelectItem value="none">No batch</SelectItem>
                      {createFormFilteredBatches.map((batch: any) => (
                        <SelectItem key={batch.id} value={batch.id}>
          ...
          <ModalFooter>
            ...
            >
              {createVaccinationMutation.isPending ? "Creating..." : "Create Vaccination"}
            </Button>
          </ModalFooter>
        </form>
      </Modal>

      {/* Create Multi-Dose Vaccination Modal */}
      <Modal
        isOpen={isMultiDoseModalOpen}
        onClose={() => setIsMultiDoseModalOpen(false)}
        title="Create Multi-Dose Vaccination Schedule"
      >
        <form onSubmit={handleCreateMultiDose}>
          <ModalContent>
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateMultiDoseForm("vaccineName", e.target.value)}
                  placeholder="e.g., IBD Vaccine"
                  required
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateMultiDoseForm("firstDoseDate", e.target.value)}
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateMultiDoseForm("totalDoses", parseInt(e.target.value))}
                    required
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateMultiDoseForm("daysBetweenDoses", parseInt(e.target.value))}
                    required
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={multiDoseForm.farmId} onValueChange={(value) => updateMultiDoseForm("farmId", value)}>
                    <SelectTrigger>
                      <SelectValue placeholder="Select farm" />
                    </SelectTrigger>
                    <SelectContent position="popper">
                ...
                <div>
                  ...
                  <Select value={multiDoseForm.batchId} onValueChange={(value) => updateMultiDoseForm("batchId", value)}>
                    <SelectTrigger>
                      <SelectValue placeholder="Select batch" />
                    </SelectTrigger>
                    <SelectContent position="popper">
                      <SelectItem value="none">No batch</SelectItem>
                      {multiDoseFormFilteredBatches.map((batch: any) => (
                        <SelectItem key={batch.id} value={batch.id}>
                          {batch.batchNumber} - {batch.farm.name}
                        </SelectItem>
                      ))}
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => updateMultiDoseForm("notes", e.target.value)}
          ...
          <ModalFooter>
            <Button
              type="button"
              variant="outline"
              onClick={() => setIsMultiDoseModalOpen(false)}
            >
              Cancel
            </Button>
            <Button
              type="submit"
              disabled={createMultiDoseMutation.isPending}
            >
              {createMultiDoseMutation.isPending ? "Creating..." : `Create ${multiDoseForm.totalDoses} Doses`}
            </Button>
          </ModalFooter>
        </form>
      </Modal>
