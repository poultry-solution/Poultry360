      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            className="flex flex-col items-start px-3 py-1.5 rounded-md border border-green-200 hover:border-green-400 hover:bg-green-50 transition-colors"
          >
        ...
        <div className="md:hidden border-t bg-white">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="border-t pt-3 space-y-3">
              ...
              >
                <span className="text-xs font-bold text-green-800 leading-tight">Contact us</span>
                <span className="flex items-center gap-1.5 text-sm font-medium text-green-700 hover:text-green-800">
