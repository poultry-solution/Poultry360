        ...
        <div className="space-y-5 lg:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <a
              ...
              className="w-full sm:w-auto min-h-[44px] border border-gray-300 hover:bg-gray-50 text-gray-700 px-6 sm:px-8 py-3 rounded-lg flex items-center justify-center gap-2 transition-colors font-medium"
            >
