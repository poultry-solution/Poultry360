...
exports.getBatchPerformanceList = exports.getMoneyToPayDetails = exports.getMoneyToReceiveDetails = exports.getDashboardPerformanceMetrics = exports.getDashboardFinancialSummary = exports.getDashboardOverview = void 0;
...
const getDashboardOverview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [totalFarms, activeBatches, completedBatches, lifetimeSales, lifetimeExpenses, currentMonthSales, lastMonthSales, currentMonthExpenses, creditSales, dealerOutstanding, recentExpenses, recentSales, recentBatches,] = yield Promise.all([
            // Total farms
            prisma_1.default.farm.count({
                where: {
                    OR: [
                        { ownerId: currentUserId },
                        { managers: { some: { id: currentUserId } } },
        ...
        const monthlyRevenueGrowth = lastMonthSalesAmount > 0
        ...
        const recentActivity = [
            ...recentExpenses.map((expense) => {
                ...
                return ({
                    ...
                    farmName: ((_a = expense.farm) === null || _a === void 0 ? void 0 : _a.name) || "General",
                });
            }),
            ...recentSales.map((sale) => {
                ...
                return ({
                    ...
                    farmName: ((_a = sale.farm) === null || _a === void 0 ? void 0 : _a.name) || "General",
                });
            }),
...
const getDashboardFinancialSummary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const currentUserId = req.userId;
        ...
        const [totalRevenue, totalExpenses, revenueByCategory, expensesByCategory, monthlyTrend,] = yield Promise.all([
            // Total revenue
            prisma_1.default.sale.aggregate({
                where: {
                    farmId: { in: farmIds },
      ...
      `,
        ...
        const revenueByCategoryFormatted = revenueByCategory.map((item) => {
            ...
            return ({
                ...
                categoryName: ((_a = categoryMap[item.categoryId]) === null || _a === void 0 ? void 0 : _a.name) || "Unknown",
...
exports.getDashboardFinancialSummary = getDashboardFinancialSummary;
// ==================== GET DASHBOARD PERFORMANCE METRICS ====================
const getDashboardPerformanceMetrics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const currentUserId = req.userId;
        // Get user's farms
        const userFarms = yield prisma_1.default.farm.findMany({
        ...
        const [batchStats, mortalityStats, feedStats, farmPerformance] = yield Promise.all([
            // Batch statistics
            prisma_1.default.batch.findMany({
                where: {
                    farmId: { in: farmIds },
        ...
        const batchPerformance = yield Promise.all(batchStats.map((batch) => __awaiter(void 0, void 0, void 0, function* () {
            const expenses = yield prisma_1.default.expense.aggregate({
            ...
            const mortality = yield prisma_1.default.mortality.aggregate({
                where: { batchId: batch.id },
                _sum: { count: true },
            });
            ...
            const duration = batch.endDate
                ? Math.ceil((batch.endDate.getTime() - batch.startDate.getTime()) /
                    (1000 * 60 * 60 * 24))
                : 0;
            return {
                batchId: batch.id,
                ...
                mortalityRate: batch.initialChicks > 0
                    ...
                    : 0,
                duration,
                profitPerBird: batch.initialChicks > 0 ? profit / batch.initialChicks : 0,
            };
        })));
        // Calculate overall metrics
        const totalInitialChicks = batchStats.reduce((sum, batch) => sum + batch.initialChicks, 0);
        const totalMortality = Number(mortalityStats._sum.count || 0);
        const totalFeedConsumption = Number(feedStats._sum.quantity || 0);
        const averageBatchProfit = batchPerformance.length > 0
            ? batchPerformance.reduce((sum, batch) => sum + batch.profit, 0) /
                batchPerformance.length
            : 0;
        const averageBatchDuration = batchPerformance.length > 0
        ...
        const topPerformingFarms = farmPerformance
            ...
            const totalProfit = completedBatches.reduce((sum, batch) => {
                const expenses = batch.expenses.reduce((sum, exp) => sum + Number(exp.amount), 0);
                const sales = batch.sales.reduce((sum, sale) => sum + Number(sale.amount), 0);
            ...
            return {
                ...
                totalProfit,
                averageProfit: completedBatches.length > 0
...
exports.getDashboardPerformanceMetrics = getDashboardPerformanceMetrics;
// ==================== GET MONEY TO RECEIVE DETAILS ====================
const getMoneyToReceiveDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const currentUserId = req.userId;
        ...
        const [creditSales, totalCreditSales] = yield Promise.all([
            prisma_1.default.sale.findMany({
                where: {
                    farmId: { in: farmIds },
                    isCredit: true,
        ...
        creditSales.forEach((sale) => {
            ...
            customer.sales.push({
                ...
                date: sale.date,
                farmName: (_a = sale.farm) === null || _a === void 0 ? void 0 : _a.name,
        ...
        const customers = Array.from(customerMap.values()).sort((a, b) => b.totalDueAmount - a.totalDueAmount);
...
exports.getMoneyToReceiveDetails = getMoneyToReceiveDetails;
// ==================== GET MONEY TO PAY DETAILS ====================
const getMoneyToPayDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const currentUserId = req.userId;
        const { page = 1, limit = 10 } = req.query;
        const skip = (Number(page) - 1) * Number(limit);
        // Get all suppliers (dealers, hatcheries, medical suppliers) with outstanding balances
        const [dealers, hatcheries, medicalSuppliers, totalDealers, totalHatcheries, totalMedicalSuppliers,] = yield Promise.all([
            prisma_1.default.dealer.findMany({
                where: { userId: currentUserId },
                include: {
                    transactions: {
            ...
            prisma_1.default.dealer.count({ where: { userId: currentUserId } }),
            prisma_1.default.hatchery.count({ where: { userId: currentUserId } }),
            prisma_1.default.medicineSupplier.count({ where: { userId: currentUserId } }),
        ]);
        ...
        const getThisMonthAmount = (transactions) => {
            const currentMonth = new Date();
            currentMonth.setDate(1);
            currentMonth.setHours(0, 0, 0, 0);
            return transactions
                .filter((t) => new Date(t.date) >= currentMonth && t.type === "PURCHASE")
        ...
        const dealersWithOutstanding = dealers
            ...
            return {
                ...
                lastTransactionDate: ((_a = dealer.transactions[0]) === null || _a === void 0 ? void 0 : _a.date) || null,
        ...
        const hatcheriesWithOutstanding = hatcheries
            ...
            return {
                ...
                lastTransactionDate: ((_a = hatchery.transactions[0]) === null || _a === void 0 ? void 0 : _a.date) || null,
        ...
        const medicalSuppliersWithOutstanding = medicalSuppliers
            ...
            return {
                ...
                lastTransactionDate: ((_a = supplier.transactions[0]) === null || _a === void 0 ? void 0 : _a.date) || null,
        ...
        const totalAmount = allSuppliersWithOutstanding.reduce((sum, supplier) => sum + supplier.outstandingAmount, 0);
        const totalSuppliers = totalDealers + totalHatcheries + totalMedicalSuppliers;
        return res.json({
            success: true,
            data: {
                totalAmount,
...
exports.getMoneyToPayDetails = getMoneyToPayDetails;
// ==================== GET BATCH PERFORMANCE LIST ====================
const getBatchPerformanceList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const currentUserId = req.userId;
        ...
        const batchesWithMetrics = yield Promise.all(batches.map((batch) => __awaiter(void 0, void 0, void 0, function* () {
            const [mortality, expenses, sales, feedConsumption, latestWeight,] = yield Promise.all([
                prisma_1.default.mortality.aggregate({
                    where: {
                        batchId: batch.id,
            ...
            const days = Math.ceil((endDate.getTime() - batch.startDate.getTime()) / (1000 * 60 * 60 * 24));
...
exports.getBatchPerformanceList = getBatchPerformanceList;
