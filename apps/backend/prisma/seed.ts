    ...
    data: [
      {
        ...
        userId: farmer1.id,
        description: "Bird feed expenses",
      },
      {
        name: "Medicine",
        type: CategoryType.EXPENSE,
  ...
  const farmer1SalesCategories = await prisma.category.createMany({
    data: [
      ...
      },
      {
        ...
        type: CategoryType.SALES,
        userId: farmer1.id,
        description: "Sale of culled chickens",
      },
    ],
  });
