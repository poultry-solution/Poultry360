...
import { Users, TrendingUp, DollarSign, Building2, Search, Filter, Download, UserPlus, Eye, Edit, Trash2 } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Users ranked by total revenue generated from their farming operations
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div key={index} className="flex items-center justify-between p-4 rounded-lg border">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{performer.farms} farms</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold">${performer.revenue.toLocaleString()}</p>
                    <p className={`text-sm ${performer.growth.startsWith('+') ? 'text-green-600' : 'text-red-600'}`}>
                      {performer.growth}
                    </p>
                  </div>
                </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Comprehensive list of all platform users with their details and performance metrics
                </CardDescription>
              </div>
